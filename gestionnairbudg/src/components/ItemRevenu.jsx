...
const ItemRevenu = ({
  ...
  let loadCat = () => {
    axios
      .get(apiUrl + "/api/gestion/categorieRlist/" + categorie + "/", {
        headers: {
  ...
  let deleteD = () => {
    axios
      .delete(apiUrl + "/api/gestion/revenu/" + id + "/", {
        headers: {
          Accept: "application/json",
          Authorization: `Bearer ${authTokens.access}`,
        },
  ...
  let editD = () => {
    axios
      .put(apiUrl + "/api/gestion/revenu/" + id + "/", updateD, {
        headers: {
          Accept: "application/json",
          Authorization: `Bearer ${authTokens.access}`,
        },
    ...
    <div className="grid grid-cols-4 w-full place-items-center h-10  border-b my-2">
      ...
      <div className="flex justify-between w-40 place-items-center">
        <button onClick={openModalE}>
          <MdModeEdit size={30} className="text-blue-500 hover:text-blue-700" />
        </button>
        ...
        <div className="w-96">
          <div className="flex w-full justify-between px-3">
            <h1 className="text-xl font-bold ">
              Suppression d'une <span className="text-yellow-500">Revenu</span>
            </h1>
      ...
      >
        <div className="w-96">
          <div className="flex w-full justify-between px-3">
            <h1 className="text-xl font-bold ">
              Modification d'un <span className="text-yellow-500">revenu</span>
            </h1>
